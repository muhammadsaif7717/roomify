...
const Navbar = () => {
    ...
    const links = <div className='font-semibold text-xl flex gap-8'>
        ...
        <Link href={`/rooms`} className={`hover:text-blue-600 ${pathName === '/rooms' && 'text-blue-500'}`}>Rooms</Link>
    ...
    return (
        <nav>
            {!hideNavbar && <div className='fixed bg-base-300 bg-opacity-75 w-full z-50'>
